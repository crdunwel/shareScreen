...
(function() {
   ...
   */
  humanize.relativeTime = function(timestamp, basetime) {
    timestamp = (timestamp === undefined) ? humanize.time() : timestamp;
    basetime = (basetime === undefined) ? humanize.time() : basetime;

    //var currTime = humanize.time(); delete above and below line to go back to vanilla
    var currTime = basetime
